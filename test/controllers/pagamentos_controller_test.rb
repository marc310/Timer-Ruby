...
class PagamentosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pagamento" do
    assert_difference('Pagamento.count') do
      post pagamentos_url, params: { pagamento: { data: @pagamento.data, descricao: @pagamento.descricao, valorPago: @pagamento.valorPago } }
    end
  ...
  test "should update pagamento" do
    patch pagamento_url(@pagamento), params: { pagamento: { data: @pagamento.data, descricao: @pagamento.descricao, valorPago: @pagamento.valorPago } }
