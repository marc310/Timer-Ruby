...
class ProjetosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create projeto" do
    assert_difference('Projeto.count') do
      post projetos_url, params: { projeto: { ativo: @projeto.ativo, descricao: @projeto.descricao, nome: @projeto.nome, precoProjeto: @projeto.precoProjeto } }
    end
  ...
  test "should update projeto" do
    patch projeto_url(@projeto), params: { projeto: { ativo: @projeto.ativo, descricao: @projeto.descricao, nome: @projeto.nome, precoProjeto: @projeto.precoProjeto } }
