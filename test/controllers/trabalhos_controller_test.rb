...
class TrabalhosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create trabalho" do
    assert_difference('Trabalho.count') do
      post trabalhos_url, params: { trabalho: { faturado: @trabalho.faturado, final: @trabalho.final, horas: @trabalho.horas, inicio: @trabalho.inicio, livre: @trabalho.livre, rendimento: @trabalho.rendimento } }
    end
  ...
  test "should update trabalho" do
    patch trabalho_url(@trabalho), params: { trabalho: { faturado: @trabalho.faturado, final: @trabalho.final, horas: @trabalho.horas, inicio: @trabalho.inicio, livre: @trabalho.livre, rendimento: @trabalho.rendimento } }
